...
public class ACEmpl extends JFrame implements ActionListener{
  ...
  public ACEmpl(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgACE.png");  
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaACEmpl.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
