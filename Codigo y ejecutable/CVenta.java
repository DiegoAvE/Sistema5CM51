...
public class CVenta extends JFrame implements ActionListener{
  ...
  public CVenta(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgCV.png");  
    ...
    textfield1.setBounds(65,170,100,25);
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaCVenta.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
