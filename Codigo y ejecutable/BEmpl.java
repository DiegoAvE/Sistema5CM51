...
public class BEmpl extends JFrame implements ActionListener{
  ...
  public BEmpl(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgBE.png");  
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaBEmpl.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
