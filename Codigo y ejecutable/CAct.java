...
public class CAct extends JFrame implements ActionListener{
  ...
  public CAct(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgCA.png");  
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaCAct.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
