...
public class Actlz extends JFrame implements ActionListener{
  ...
  public Actlz(){
    ...
    ImageIcon imagen3 = new ImageIcon("images/imgMAC.png");  
    label2 = new JLabel(imagen3);
    label2.setBounds(145,42,355,75);
    add(label2);
  ...
  public void actionPerformed(ActionEvent e){
    ...
    if(e.getSource() == boton1){
      ...
      ACVenta ventanaACVenta = new ACVenta();
      ventanaACVenta.setBounds(0,0,550,550);
      ventanaACVenta.setVisible(true);
      ventanaACVenta.setResizable(false);
      ventanaACVenta.setLocationRelativeTo(null);
      this.setVisible(false);
    }
    if(e.getSource() == boton2){

      ACClint ventanaACClint = new ACClint();
      ventanaACClint.setBounds(0,0,550,630);
    ...
    if(e.getSource() == boton3){
      ...
      ACPro ventanaACPro = new ACPro();
      ventanaACPro.setBounds(0,0,550,550);
      ventanaACPro.setVisible(true);
      ventanaACPro.setResizable(false);
      ventanaACPro.setLocationRelativeTo(null);
      this.setVisible(false);
    }
    if(e.getSource() == boton4){

      ACEmpl ventanaACEmpl = new ACEmpl();
      ventanaACEmpl.setBounds(0,0,550,550);
      ventanaACEmpl.setVisible(true);
      ventanaACEmpl.setResizable(false);
      ventanaACEmpl.setLocationRelativeTo(null);
      this.setVisible(false);
    }
    if(e.getSource() == boton5){

      ACAct ventanaACAct = new ACAct();
      ventanaACAct.setBounds(0,0,550,550);
   ...
   public static void main(String args[]){
     ...
     ventanaActlz.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
