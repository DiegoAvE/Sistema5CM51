...
public class Bajas extends JFrame implements ActionListener{
  ...
  public Bajas(){
    ...
    ImageIcon imagen3 = new ImageIcon("images/imgMB.png");  
    label2 = new JLabel(imagen3);
    label2.setBounds(145,42,335,70);
    add(label2);
  ...
  public void actionPerformed(ActionEvent e){
    ...
    if(e.getSource() == boton1){
      ...
      BVenta ventanaBVenta = new BVenta();
      ventanaBVenta.setBounds(0,0,550,550);
      ventanaBVenta.setVisible(true);
      ventanaBVenta.setResizable(false);
      ventanaBVenta.setLocationRelativeTo(null);
      this.setVisible(false);

    }
    if(e.getSource() == boton2){

      BClint ventanaBClint = new BClint();
      ventanaBClint.setBounds(0,0,550,550);
      ventanaBClint.setVisible(true);
      ventanaBClint.setResizable(false);
      ventanaBClint.setLocationRelativeTo(null);
      this.setVisible(false);

    }
    if(e.getSource() == boton3){

      BPro ventanaBPro = new BPro();
      ventanaBPro.setBounds(0,0,550,550);
      ventanaBPro.setVisible(true);
      ventanaBPro.setResizable(false);
      ventanaBPro.setLocationRelativeTo(null);
      this.setVisible(false);

    }
    if(e.getSource() == boton4){

      BEmpl ventanaBEmpl = new BEmpl();
      ventanaBEmpl.setBounds(0,0,550,550);
      ventanaBEmpl.setVisible(true);
      ventanaBEmpl.setResizable(false);
      ventanaBEmpl.setLocationRelativeTo(null);
      this.setVisible(false);

    }
    if(e.getSource() == boton5){

      BAct ventanaBAct = new BAct();
      ventanaBAct.setBounds(0,0,550,550);
      ventanaBAct.setVisible(true);
      ventanaBAct.setResizable(false);
      ventanaBAct.setLocationRelativeTo(null);
      this.setVisible(false);
   ...
   public static void main(String args[]){
     ...
     ventanaBajas.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
