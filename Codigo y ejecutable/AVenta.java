...
public class AVenta extends JFrame implements ActionListener{
  ...
  public AVenta(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgAV.png");  
    ...
    boton2 = new JButton("Finalizar Venta");
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaAVenta.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
