...
public class ACVenta extends JFrame implements ActionListener{
  ...
  public ACVenta(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgACV.png");  
    ...
    label5 = new JLabel("Fecha de venta:");
    ...
    boton3.setBounds(350,245,170,30);
    ...
    label6 = new JLabel("Hora de venta:");
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaACVenta.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
