...
public class BClint extends JFrame implements ActionListener{
  ...
  public BClint(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgBC.png");  
    ...
    boton3.setBounds(375,400,100,25);
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaBClint.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
