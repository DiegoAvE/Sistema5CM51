...
public class ACPro extends JFrame implements ActionListener{
  ...
  public ACPro(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgACP.png");  
    ...
    boton3.setBounds(340,245,185,30);
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaACPro.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
