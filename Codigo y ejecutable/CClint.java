...
public class CClint extends JFrame implements ActionListener{
  ...
  public CClint(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgCC.png");  
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaCClint.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
