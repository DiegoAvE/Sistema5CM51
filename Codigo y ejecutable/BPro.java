...
public class BPro extends JFrame implements ActionListener{
  ...
  public BPro(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgBP.png");  
    ...
    textfield1.setText("  ID_Producto:");
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaBPro.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
