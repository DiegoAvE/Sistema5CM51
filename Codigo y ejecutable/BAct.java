...
public class BAct extends JFrame implements ActionListener{
  ...
  public BAct(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgBA.png");  
    ...
    textfield1.setText("  ID_Actividad:");
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaBAct.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
