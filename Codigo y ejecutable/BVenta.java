...
public class BVenta extends JFrame implements ActionListener{
  ...
  public BVenta(){
    ...
    ImageIcon imagen2 = new ImageIcon("images/imgBV.png");  
  ...
  public void actionPerformed(ActionEvent e){
   ...
   public static void main(String args[]){
     ...
     ventanaBVenta.setBounds(0,0,550,550); // El primero es el ancho y el segundo el alto
